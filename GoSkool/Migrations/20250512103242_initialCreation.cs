        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classes_Section_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Section",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Classes_Standard_StandardId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subject_Classes_ClassEntityId",
            ...
            migrationBuilder.CreateTable(
                name: "TeacherPeriodEntity",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClassId = table.Column<int>(type: "int", nullable: false),
                    breakPeriod = table.Column<bool>(type: "bit", nullable: false),
                    TeacherEntityId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherPeriodEntity", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeacherPeriodEntity_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherPeriodEntity_Teachers_TeacherEntityId",
                        column: x => x.TeacherEntityId,
                        principalTable: "Teachers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherPeriodEntity_ClassId",
                table: "TeacherPeriodEntity",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherPeriodEntity_TeacherEntityId",
                table: "TeacherPeriodEntity",
                column: "TeacherEntityId");
        }
