...
namespace GoSkool.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel()
            {
                ...
                ClassList = _context.Classes.Include(x=>x.Standard).Include(x=>x.Section).Select(y=>new SelectListItem
                {
        ...
        private GoSkoolUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<GoSkoolUser>();
            }
            catch
            {
